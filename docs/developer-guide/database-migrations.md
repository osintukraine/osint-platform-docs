...
### Step 4: Test ORM Compatibility

```bash
# Run tests to verify ORM works with new schema
docker-compose exec api pytest tests/
```

### Step 5: Update Documentation

Edit `docs/reference/database-tables.md` to document the new column/table.
...
Run:
```bash
docker-compose exec api python scripts/migrate_v1_to_v2.py
```
...
The platform doesn't track schema versions automatically. Track manually:

### Option 1: Comment in init.sql

```sql
-- Schema Version: 2025-12-09-v1
-- Changes:
--   - Added new_field to messages
--   - Added my_new_table
```

### Option 2: Version Table
...
VALUES ('2025-12-09-v1', 'Added new_field to messages')
...
print(msg.new_field)  # Should work without error
```
